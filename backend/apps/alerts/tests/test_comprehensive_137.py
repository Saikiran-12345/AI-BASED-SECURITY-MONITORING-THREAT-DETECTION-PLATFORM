...
class AlertsComprehensiveTestCase137(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.username = f'testuser_alerts_137_{uuid.uuid4().hex[:6]}'
    ...
    def test_endpoint_resolution(self):
        """Verify endpoint routing resolution for app alerts."""
        response = self.client.options('/api/alerts/')
