...
class RiskComprehensiveTestCase139(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.username = f'testuser_risk_139_{uuid.uuid4().hex[:6]}'
    ...
    def test_endpoint_resolution(self):
        """Verify endpoint routing resolution for app risk."""
        response = self.client.options('/api/risk/')
