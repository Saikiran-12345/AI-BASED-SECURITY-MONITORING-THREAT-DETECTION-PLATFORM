...
class AnalyticsComprehensiveTestCase131(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.username = f'testuser_analytics_131_{uuid.uuid4().hex[:6]}'
    ...
    def test_endpoint_resolution(self):
        """Verify endpoint routing resolution for app analytics."""
        response = self.client.options('/api/analytics/')
