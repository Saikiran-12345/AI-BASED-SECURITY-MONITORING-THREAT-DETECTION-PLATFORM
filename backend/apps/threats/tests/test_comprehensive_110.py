...
class ThreatsComprehensiveTestCase110(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.username = f'testuser_threats_110_{uuid.uuid4().hex[:6]}'
    ...
    def test_endpoint_resolution(self):
        """Verify endpoint routing resolution for app threats."""
        response = self.client.options('/api/threats/')
