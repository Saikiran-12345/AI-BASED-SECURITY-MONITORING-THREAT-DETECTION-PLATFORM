...
class AccountsComprehensiveTestCase114(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.username = f'testuser_accounts_114_{uuid.uuid4().hex[:6]}'
    ...
    def test_endpoint_resolution(self):
        """Verify endpoint routing resolution for app accounts."""
        response = self.client.options('/api/accounts/')
