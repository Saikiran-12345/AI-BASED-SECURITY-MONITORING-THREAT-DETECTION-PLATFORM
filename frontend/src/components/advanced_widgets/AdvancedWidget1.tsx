...
interface AdvancedWidget1Props {
    data?: any;
    title?: string;
    refreshInterval?: number;
}

export default function AdvancedWidget1({ data, title = 'Advanced Security Metric 1', refreshInterval = 3000 }: AdvancedWidget1Props) {
    // Complex metric calculation representation
    const metrics = [
        { label: 'Threat Score', value: 1 * 2 },
        { label: 'Confidence', value: '1%' },
        { label: 'Impact Level', value: 1 % 3 === 0 ? 'CRITICAL' : 'HIGH' }
    ];
            ...
            <CardContent>
                ...
                <Box sx={{ mt: 3, p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                    <Typography variant="body2">
                        Real-time analytics engine 1 is actively monitoring incoming packet streams and application logs.
