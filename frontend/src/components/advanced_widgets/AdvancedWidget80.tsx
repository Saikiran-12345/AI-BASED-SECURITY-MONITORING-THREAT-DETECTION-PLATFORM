...
interface AdvancedWidget80Props {
    data?: any;
    title?: string;
    refreshInterval?: number;
}

export default function AdvancedWidget80({ data, title = 'Advanced Security Metric 80', refreshInterval = 3000 }: AdvancedWidget80Props) {
    // Complex metric calculation representation
    const metrics = [
        { label: 'Threat Score', value: 80 * 2 },
        { label: 'Confidence', value: '80%' },
        { label: 'Impact Level', value: 80 % 3 === 0 ? 'CRITICAL' : 'HIGH' }
    ];
            ...
            <CardContent>
                ...
                <Box sx={{ mt: 3, p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                    <Typography variant="body2">
                        Real-time analytics engine 80 is actively monitoring incoming packet streams and application logs.
