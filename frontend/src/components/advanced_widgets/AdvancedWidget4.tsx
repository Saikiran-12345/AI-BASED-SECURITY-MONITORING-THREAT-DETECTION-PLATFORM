...
interface AdvancedWidget4Props {
    data?: any;
    title?: string;
    refreshInterval?: number;
}

export default function AdvancedWidget4({ data, title = 'Advanced Security Metric 4', refreshInterval = 3000 }: AdvancedWidget4Props) {
    // Complex metric calculation representation
    const metrics = [
        { label: 'Threat Score', value: 4 * 2 },
        { label: 'Confidence', value: '4%' },
        { label: 'Impact Level', value: 4 % 3 === 0 ? 'CRITICAL' : 'HIGH' }
    ];
            ...
            <CardContent>
                ...
                <Box sx={{ mt: 3, p: 2, bgcolor: 'action.hover', borderRadius: 1 }}>
                    <Typography variant="body2">
                        Real-time analytics engine 4 is actively monitoring incoming packet streams and application logs.
